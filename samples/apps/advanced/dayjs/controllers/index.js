...
//
// do this:  require('alloy/dayjs/locale/es');
// NOT this: require('alloy/dayjs/locale/' + locale);
require('alloy/dayjs/locale/de');
require('alloy/dayjs/locale/fr');

// Optional dayjs features come as plugins that need to be registered
// with dayjs.extend() before use.
dayjs.extend(require('alloy/dayjs/plugin/advancedFormat'));
...
function updateDate() {
	$.theDate.text = dayjs().format('MMMM Do YYYY, h:mm:ss a');
}
