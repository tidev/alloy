var GOOGLE_BASE_URL = "http://maps.googleapis.com/maps/geo?output=json&q=", ERROR_MESSAGE = "There was an error geocoding. Please try again.", GeoData = function(title, latitude, longitude) {
    this.title = title;
    this.coords = {
        latitude: latitude,
        longitude: longitude
...
exports.forwardGeocode = function(address, callback) {
    Ti.Platform.osname === "mobileweb" ? forwardGeocodeWeb(address, callback) : forwardGeocodeNative(address, callback);
};
...
var forwardGeocodeNative = function(address, callback) {
    ...
    xhr.send();
}, forwardGeocodeWeb = function(address, callback) {
