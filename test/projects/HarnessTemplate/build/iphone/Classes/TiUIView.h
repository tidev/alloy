...
/**
 Base class for all HarnessTemplate views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HarnessTemplate view hierarchy (such as wrapped iOS UIViews) was touched.
