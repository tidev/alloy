...
@interface HarnessTemplateObject : KrollCoverageObject {
#else
@interface HarnessTemplateObject : KrollObject {
#endif
@private
...
extern NSString * HarnessTemplate$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HarnessTemplateObject *_harnesstemplate;
    KrollObject* console;
	BOOL shutdown;
