...
//@interface HarnessTemplateObject : NSObject
//@end

@interface HarnessTemplateObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HarnessTemplateObject class]])
		{
			for (NSString *key in [[(HarnessTemplateObject*)o modules] allKeys])
			{
