...
// in simulator we redefine to format for HarnessTemplate Developer console
...
{\
	NSString * exceptionName = [@"org.harnesstemplate." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.harnesstemplate";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIHarnessTemplateNativeItemNone = -1, 
	UIHarnessTemplateNativeItemSpinner = -2,
	UIHarnessTemplateNativeItemProgressBar = -3,
	
	UIHarnessTemplateNativeItemSlider = -4,
	UIHarnessTemplateNativeItemSwitch = -5,
	UIHarnessTemplateNativeItemMultiButton = -6,
	UIHarnessTemplateNativeItemSegmented = -7,
	
	UIHarnessTemplateNativeItemTextView = -8,
	UIHarnessTemplateNativeItemTextField = -9,
	UIHarnessTemplateNativeItemSearchBar = -10,
	
	UIHarnessTemplateNativeItemPicker = -11,
	UIHarnessTemplateNativeItemDatePicker = -12,
	
	UIHarnessTemplateNativeItemInfoLight = -13,
	UIHarnessTemplateNativeItemInfoDark = -14,
	
	UIHarnessTemplateNativeItemDisclosure = -15,
	
	UIHarnessTemplateNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HarnessTemplate instances of
