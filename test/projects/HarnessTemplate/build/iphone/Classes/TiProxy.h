...
//Rare exceptions to indicate a bug in the _harnesstemplate code (Eg, function that a subclass should have implemented)
...
/**
 The base class for HarnessTemplate proxies.
 */
