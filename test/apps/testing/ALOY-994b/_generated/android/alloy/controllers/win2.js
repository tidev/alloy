...
function Controller() {
    ...
    __defers["$.__views.__alloyId18!click!doClick"] && $.addListener($.__views.__alloyId18, "click", doClick);
    __defers["$.__views.__alloyId20!click!doClick"] && $.addListener($.__views.__alloyId20, "click", doClick);
    _.extend($, exports);
}
