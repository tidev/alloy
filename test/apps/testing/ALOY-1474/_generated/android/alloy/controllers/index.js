...
function Controller() {
    function __alloyId20(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId18 = {
                title: _.template("{foo}", __alloyId16.__transform, {
                    interpolate: /\{([\s\S]+?)\}/g
                })
            };
    ...
    function __alloyId29(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId27 = {
                title: _.template("{foo} and {bar}", __alloyId25.__transform, {
                    interpolate: /\{([\s\S]+?)\}/g
                })
            };
    ...
    function __alloyId38(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId36 = {
                title: _.template("{foo} and {bar}", __alloyId34.__transform, {
                    interpolate: /\{([\s\S]+?)\}/g
                })
            };
    ...
    function __alloyId47(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId45 = {
                title: _.template("{foo}", __alloyId43.__transform, {
                    interpolate: /\{([\s\S]+?)\}/g
                })
            };
    ...
    function __alloyId56(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId54 = {
                title: _.template("{foo} and {bar}", __alloyId52.__transform, {
                    interpolate: /\{([\s\S]+?)\}/g
                })
            };
    ...
    function __alloyId65(e) {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId63 = {
                title: _.template("{foo} and {bar}", __alloyId61.__transform, {
                    interpolate: /\{([\s\S]+?)\}/g
                })
            };
