  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_pair() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, value) { return [name, value]; })(pos0, result0[1], result0[5]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_LocaleCall() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              pos2 = pos;
              result3 = parse_paramComma();
              if (result3 !== null) {
                result4 = parse_paramString();
                if (result4 !== null) {
