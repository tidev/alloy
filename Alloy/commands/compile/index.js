...
module.exports = function(args, program) {
	...
	U.copyAlloyDir(inputPath, [CONST.DIR.LIB], path.join(compileConfig.dir.resources,CONST.DIR.LIB));
	U.copyAlloyDir(inputPath, [CONST.DIR.ASSETS], compileConfig.dir.resources);
