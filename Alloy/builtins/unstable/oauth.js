 ...
 * var oAuthAdapter = require('alloy/oauth').create(	
 ...
 * 
 */
var b64_hmac_sha1 = require('alloy/sha1').b64_hmac_sha1;

exports.create = function(consumerSecret, consumerKey, signatureMethod)
{
	return new OAuthAdapter(consumerSecret, consumerKey, signatureMethod || 'HMAC-SHA1');
};
