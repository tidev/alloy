...
-   [ALOY-1737](https://jira-archive.titaniumsdk.com/ALOY-1737) - Set items directly in ListView [#966](https://github.com/tidev/alloy/pull/966)
-   [ALOY-1738](https://jira-archive.titaniumsdk.com/ALOY-1738) - Fix handling of Require tags [#967](https://github.com/tidev/alloy/pull/967)

### Release 1.15.1

## Improvements

-   [ALOY-1735](https://jira-archive.titaniumsdk.com/ALOY-1735) - Create VS Code settings.json file on project creation [#965](https://github.com/tidev/alloy/pull/965)

### Bug Fixes

-   [ALOY-1736](https://jira-archive.titaniumsdk.com/ALOY-1736) - Ensure package.json has correct fields [#965](https://github.com/tidev/alloy/pull/965)

### Release 1.15.0

### New Features

-   [ALOY-1732](https://jira-archive.titaniumsdk.com/ALOY-1732) - Add ability to run in the background without UI [#959](https://github.com/tidev/alloy/pull/959)
-   [ALOY-1733](https://jira-archive.titaniumsdk.com/ALOY-1733) - Add template for Alloy + webpack usage [#963](https://github.com/tidev/alloy/pull/963)

### Improvements

-   [ALOY-1256](https://jira-archive.titaniumsdk.com/ALOY-1256) - Allow using a Widget as a primary control in an XML View [#949](https://github.com/tidev/alloy/pull/949)
-   [ALOY-1253](https://jira-archive.titaniumsdk.com/ALOY-1253) - Support WPATH in widget XML view attribute values [#948](https://github.com/tidev/alloy/pull/948)

### Bug Fixes

-   [ALOY-1720](https://jira-archive.titaniumsdk.com/ALOY-1720) - Version string comparison will break for SDK 10.0.0 [#960](https://github.com/tidev/alloy/pull/960)
-   [ALOY-1734](https://jira-archive.titaniumsdk.com/ALOY-1734) - Declare Alloy globals before execution of app.js/alloy.js [#964](https://github.com/tidev/alloy/pull/964)

### Release 1.14.6

-   [ALOY-1721](https://jira-archive.titaniumsdk.com/ALOY-1721) - Alloy global can no longer be accessed in styles [#955](https://github.com/tidev/alloy/issues/955)
...
-   [ALOY-1710](https://jira-archive.titaniumsdk.com/ALOY-1710) - Fix undeclared variable error [#947](https://github.com/tidev/alloy/pull/947)

### Release 1.14.2

-   [ALOY-1598](https://jira-archive.titaniumsdk.com/ALOY-1598) - Fix error with binding_no_persistence sample [#882](https://github.com/tidev/alloy/pull/882)
-   [ALOY-1693](https://jira-archive.titaniumsdk.com/ALOY-1693) - Maintain db connection during sql sync [#933](https://github.com/tidev/alloy/pull/933)
-   [ALOY-1633](https://jira-archive.titaniumsdk.com/ALOY-1633) - Inject \_, Alloy, and Backbone variables into files when used rather than make available as globals [#911](https://github.com/tidev/alloy/pull/911)
-   [ALOY-1701](https://jira-archive.titaniumsdk.com/ALOY-1701) - XML: Unable to use platform namespace restriction on event handlers [#940](https://github.com/tidev/alloy/pull/940)
-   [ALOY-1705](https://jira-archive.titaniumsdk.com/ALOY-1705) - Fix to allow return outside of function [#939](https://github.com/tidev/alloy/pull/939)
-   [ALOY-1706](https://jira-archive.titaniumsdk.com/ALOY-1706) - Compile error if Alloy view filename contains hyphen [#938](https://github.com/tidev/alloy/pull/938)

### Release 1.14.1

#### Improvements

-   [ALOY-1697](https://jira-archive.titaniumsdk.com/ALOY-1697) - Add WebView "onlink" callback support

#### Bug Fixes

-   [ALOY-1698](https://jira-archive.titaniumsdk.com/ALOY-1698) - Compile: Errors thrown during sourcemap step are not visible to a user

### Release 1.14.0

#### New Features

-   [ALOY-1632](https://jira-archive.titaniumsdk.com/ALOY-1632) Allow passing custom template directories to the `alloy new` command [#912](https://github.com/tidev/alloy/pull/912)
-   [ALOY-1646](https://jira-archive.titaniumsdk.com/ALOY-1646) Allow platform xml namespaces to be used with xml attributes in Alloy [#922](https://github.com/tidev/alloy/pull/922)
...
-   [ALOY-1363](https://jira-archive.titaniumsdk.com/ALOY-1363) Add support to set object properties via XML [#765](https://github.com/tidev/alloy/pull/765)
...
-   [ALOY-1316](https://jira-archive.titaniumsdk.com/ALOY-1316) Support use of $.args.\* in any XML attribute or TSS property [#885](https://github.com/tidev/alloy/pull/885)

#### Improvements

-   [ALOY-1629](https://jira-archive.titaniumsdk.com/ALOY-1629) Upgrade to babel 7 packages [#905](https://github.com/tidev/alloy/pull/905)
-   [ALOY-1652](https://jira-archive.titaniumsdk.com/ALOY-1652) Improve handling of missing directories and files in `alloy new` [#925](https://github.com/tidev/alloy/pull/925)
-   [ALOY-1682](https://jira-archive.titaniumsdk.com/ALOY-1682) Update to moment to 2.24.0 and update moment locales. [#928](https://github.com/tidev/alloy/pull/928)
...
-   [ALOY-1683](https://jira-archive.titaniumsdk.com/ALOY-1683) Update to Underscore.js 1.9.1 [#929](https://github.com/tidev/alloy/pull/929)
    -   Previous version was 1.8.3
-   [ALOY-1648](https://jira-archive.titaniumsdk.com/ALOY-1648) Include Backbone.js 1.4.0 [#929](https://github.com/tidev/alloy/pull/929)
    -   Includes 42 new locales
-   [ALOY-1505](https://jira-archive.titaniumsdk.com/ALOY-1505) Add ability to set cancel and destructive properties on OptionDialog options [#879](https://github.com/tidev/alloy/pull/879)
-   [ALOY-1612](https://jira-archive.titaniumsdk.com/ALOY-1612) CLI: Be able to use Alloy source-maps in Safari Debugger / Chrome Dev-Tools [#893](https://github.com/tidev/alloy/pull/893)

#### Fixes

-   [ALOY-1535](https://jira-archive.titaniumsdk.com/ALOY-1535) Only warn when using an AlertDialog with child views not restricted to Android [#810](https://github.com/tidev/alloy/pull/810)
-   [ALOY-1653](https://jira-archive.titaniumsdk.com/ALOY-1653) Runtime error on Android when using optiondialog and not declaring destructive or cancel properties [#926](https://github.com/tidev/alloy/pull/926)
-   [ALOY-1684](https://jira-archive.titaniumsdk.com/ALOY-1684) Calling sort for a collection does not call the dataFunction as of backbone 1.1.2 and above [#929](https://github.com/tidev/alloy/pull/929)
-   [ALOY-1690](https://jira-archive.titaniumsdk.com/ALOY-1690) sourcemaps not being generated for files under lib [#893](https://github.com/tidev/alloy/pull/893)
-   [ALOY-1691](https://jira-archive.titaniumsdk.com/ALOY-1691) Source maps report incorrect "file" value [#893](https://github.com/tidev/alloy/pull/893)

### Release 1.13.10

#### Fixes

[ALOY-1686](https://jira-archive.titaniumsdk.com/ALOY-1686) Alloy: App crashes due to context used when accessing Ti.Database API

### Release 1.13.9

#### Fixes

[ALOY-1650](https://jira-archive.titaniumsdk.com/ALOY-1650) Debugger does not hit breakpoints when running Android on Windows

### Release 1.13.8

#### Fixes

[ALOY-1644](https://jira-archive.titaniumsdk.com/ALOY-1644) Selective compilation does not regenerate platform app.js on Windows

### Release 1.13.7

#### Fixes

[ALOY-1641](https://jira-archive.titaniumsdk.com/ALOY-1641) iOS: TabbedBar usage on lower than SDK 8 is broken

### Release 1.13.6

#### Improvements

[ALOY-1640](https://jira-archive.titaniumsdk.com/ALOY-1640) Update TabbedBar to use the Ti.UI namespace

#### Fixes

[ALOY-1637](https://jira-archive.titaniumsdk.com/ALOY-1637) ES6 code frame fails when using duplicate variable declarations
[ALOY-1639](https://jira-archive.titaniumsdk.com/ALOY-1639) Update animation library to use `createMatrix3D/createMatrix2D` in place of the deprecated `create3DMatrix/create2DMatrix`

### Release 1.13.5

[ALOY-1638](https://jira-archive.titaniumsdk.com/ALOY-1638) Theme is "null" when a theme is defined in config.json
...
[TIMOB-24817](https://jira-archive.titaniumsdk.com/TIMOB-24817) Support defining Alloy widgets in ListView templates
...
-   [ALOY-1597](https://jira-archive.titaniumsdk.com/ALOY-1597): Improve compile error messages to include a code frame that point to source locations
-   [ALOY-1596](https://jira-archive.titaniumsdk.com/ALOY-1596): Do not copy Mobileweb assets on alloy new
-   [ALOY-1592](https://jira-archive.titaniumsdk.com/ALOY-1592): Builtins: Reimplement measurement by convertUnits
-   [ALOY-1534](https://jira-archive.titaniumsdk.com/ALOY-1534): Add support for Backbone 1.3.3 and Underscore 1.8.3
-   [ALOY-1528](https://jira-archive.titaniumsdk.com/ALOY-1528): Checks the theme’s config.json for dependencies when
...
-   [ALOY-1168](https://jira-archive.titaniumsdk.com/ALOY-1168): Replace Underscore with Lodash for Alloy compile
...
-   [ALOY-1593](https://jira-archive.titaniumsdk.com/ALOY-1593): Android Debugger: Some breakpoints not hit if "Resume"
...
-   [ALOY-1590](https://jira-archive.titaniumsdk.com/ALOY-1590): OS_IOS assigned to a variable causes a crash
...
-   [CLI-1272](https://jira-archive.titaniumsdk.com/CLI-1272): Removed mobileweb and blackberry from studio config.json
    template
-   [ALOY-1584](https://jira-archive.titaniumsdk.com/ALOY-1584): Android: Ti.UI.Toolbar has no click event
...
-   [ALOY-1318](https://jira-archive.titaniumsdk.com/ALOY-1318): DefaultIcon(-platform).png should be theme-able
...
-   [CLI-1272](https://jira-archive.titaniumsdk.com/CLI-1272): Remove "mobileweb" from config template
-   [CLI-1273](https://jira-archive.titaniumsdk.com/CLI-1273): Fallback if empty ResultSet is returned
...
-   [ALOY-1582](https://jira-archive.titaniumsdk.com/ALOY-1582): Fix Ti.Platform.osname on Windows
...
-   [ALOY-1574](https://jira-archive.titaniumsdk.com/ALOY-1574): Unable to use ES6 import/exports in alloy controllers
-   [TIMOB-25269](https://jira-archive.titaniumsdk.com/TIMOB-25269): iOS: Add iPhone X screenshots
-   [ALOY-1579](https://jira-archive.titaniumsdk.com/ALOY-1579): Support Titanium.UI.Android.DrawerLayout
-   [ALOY-1578](https://jira-archive.titaniumsdk.com/ALOY-1578): Move Ti.UI.iOS.Toolbar to Ti.UI.Toolbar
-   [ALOY-1572](https://jira-archive.titaniumsdk.com/ALOY-1572): Alloy doesn't compile external app.js
-   [ALOY-1564](https://jira-archive.titaniumsdk.com/ALOY-1564): Broken Require data-binding event translation
-   [ALOY-1524](https://jira-archive.titaniumsdk.com/ALOY-1524): Replace wrench with fs-extra
...
-   [ALOY-1570](https://jira-archive.titaniumsdk.com/ALOY-1570): exports.baseController does not work since 1.10.0
...
-   [ALOY-1567](https://jira-archive.titaniumsdk.com/ALOY-1567): Minification produces invalid code
...
-   [ALOY-1565](https://jira-archive.titaniumsdk.com/ALOY-1565): KitchenSink v2 errors out on iOS
...
-   [ALOY-1312](https://jira-archive.titaniumsdk.com/ALOY-1312): Upgrade Alloy to support ES6
...
-   [ALOY-1365](https://jira-archive.titaniumsdk.com/ALOY-1365): Added support
...
-   [CLI-768](https://jira-archive.titaniumsdk.com/CLI-768): Alloy app fails to build on Windows with
...
-   [ALOY-1300](https://jira-archive.titaniumsdk.com/ALOY-1300): iOS Assets Catalog inconsistency between
    Alloy and Classic
...
-   [ALOY-1239](https://jira-archive.titaniumsdk.com/ALOY-1239): Set Node 0.10 as minimum supported version

#### Fixed

-   [ALOY-1299](https://jira-archive.titaniumsdk.com/ALOY-1299): Cannot build a new project for iOS
    due to missing appicons
-   [ALOY-1226](https://jira-archive.titaniumsdk.com/ALOY-1226): To Do sample app - validate() fails
...
-   [ALOY-1288](https://jira-archive.titaniumsdk.com/ALOY-1288): Windows: Label not visible when using default app.tss
-   [ALOY-1287](https://jira-archive.titaniumsdk.com/ALOY-1287): Alloy styles compilation does not produce the
...
-   [ALOY-1280](https://jira-archive.titaniumsdk.com/ALOY-1280): Support CommandBar in XML markup on Windows

#### Fixed

-   [ALOY-1214](https://jira-archive.titaniumsdk.com/ALOY-1214): Button in Inheritance sample app difficult to click on iOS
...
-   [ALOY-1272](https://jira-archive.titaniumsdk.com/ALOY-1272): Building an Alloy project with
...
For details, see the
[Alloy Backbone Migration guide](https://titaniumsdk.com/guide/Alloy_Backbone_Migration).
...
-   [ALOY-1149](https://jira-archive.titaniumsdk.com/ALOY-1149). iOS: Gradient array properties are converted into objects
...
For more details, see [Alloy Data Binding](https://titaniumsdk.com/guide/Alloy_Data_Binding).
...
-   Support setting ActionBar properties in XML and TSS using the `ActionBar` element. For XML
    ...
    [Alloy XML Markup](https://titaniumsdk.com/guide/Alloy_XML_Markup).
...
-   [ALOY-1091](https://jira-archive.titaniumsdk.com/ALOY-1091). id property of <Picker> other than 'picker' is treated as a variable
-   [ALOY-1094](https://jira-archive.titaniumsdk.com/ALOY-1094). Date or time pickers: cannot use Ti.UI._ type constants, must use Titanium.UI._ abbreviations
...
2. Use the [updateViews()](https://titaniumsdk.com/api/Alloy.Controller-method-updateViews)
...
-   [Alloy Guides: Views without Controllers](https://titaniumsdk.com/guide/Views_without_Controllers)
...
-   [Alloy Styles and Themes: Custom Query Styles](https://titaniumsdk.com/guide/Alloy_Styles_and_Themes-section-35621526_AlloyStylesandThemes-CustomQueryStyles)
...
This release introduces better integration with the [ti.map module](https://titaniumsdk.com/api/Modules.Map),
...
-   Alloy Example in [ti.map module](https://titaniumsdk.com/api/Modules.Map)
...
-   "Themes" section in [Alloy Widgets](https://titaniumsdk.com/guide/Alloy_Widgets)
...
-   Support Date Picker attributes. The
    [maxDate](https://titaniumsdk.com/api/Titanium.UI.Picker-property-maxDate)
    [minDate](https://titaniumsdk.com/api/Titanium.UI.Picker-property-minDate),
    and [value](https://titaniumsdk.com/api/Titanium.UI.Picker-property-value)
...
-   Support [Titanium.UI.RefreshControl](https://titaniumsdk.com/api/Titanium.UI.RefreshControl)
...
-   [ALOY-905](https://jira-archive.titaniumsdk.com/ALOY-905). Alloy now supports TiSDK 3.0.0+ again!
-   [ALOY-907](https://jira-archive.titaniumsdk.com/ALOY-907). Fixed unhandled exception errors in invalid JS.
-   [ALOY-912](https://jira-archive.titaniumsdk.com/ALOY-912). Better handling of runtime conditionals on TableView proxy properties.
-   [ALOY-914](https://jira-archive.titaniumsdk.com/ALOY-914). Show Alloy appicon instead of Titanium default.
-   [ALOY-916](https://jira-archive.titaniumsdk.com/ALOY-916). Copy theme assets to platform-specific folders.
-   [ALOY-920](https://jira-archive.titaniumsdk.com/ALOY-920). Fixes compile time error when using should.js.
-   [ALOY-922](https://jira-archive.titaniumsdk.com/ALOY-922). Fixes error when using proxy properties on a TextField in an ItemTemplate.
-   [ALOY-937](https://jira-archive.titaniumsdk.com/ALOY-937). Fixes copying of platform-specific widget assets.
...
-   [TIMOB-14884](https://jira-archive.titaniumsdk.com/TIMOB-14884)
-   [ALOY-760](https://jira-archive.titaniumsdk.com/ALOY-760)
...
-   [ALOY-813](https://jira-archive.titaniumsdk.com/ALOY-813). Fixed bug handling unicode characters in XML attributes.
-   [ALOY-817](https://jira-archive.titaniumsdk.com/ALOY-817). Fixed bug adding XML event handlers to UI components that use custom namesapces.
-   [ALOY-815](https://jira-archive.titaniumsdk.com/ALOY-815) & [ALOY-818](https://jira-archive.titaniumsdk.com/ALOY-818). Support Ti.UI.iOS.NavigationWindow API in XML

---

### Release 1.2.1 (27 August 2013)

-   [ALOY-789](https://jira-archive.titaniumsdk.com/ALOY-789). Fixed improper handling of printable escape characters in TSS.
-   [ALOY-802](https://jira-archive.titaniumsdk.com/ALOY-802). Fixed escape character handling issue in TSS on Windows.
-   [ALOY-803](https://jira-archive.titaniumsdk.com/ALOY-803). Fixed issue with controller subfolders on Windows.
-   [ALOY-804](https://jira-archive.titaniumsdk.com/ALOY-804). Fixed issues with `jake` on Windows.
...
-   [Dynamic Styles guide](https://titaniumsdk.com/guide/Dynamic_Styles)
...
-   [ListView API Reference](https://titaniumsdk.com/api/Titanium.UI.ListView)
...
-   "Module XML Element" section in the [Alloy XML Markup guide](https://titaniumsdk.com/guide/Alloy_XML_Markup)
...
[Alloy Tasks guide](https://titaniumsdk.com/guide/Alloy_Tasks).
...
-   [ALOY-661](https://jira-archive.titaniumsdk.com/ALOY-661). Code Processor: Get Alloy to recompile before an analysis
...
-   [ALOY-424](https://jira-archive.titaniumsdk.com/ALOY-424). Blackberry support

#### Bug Fixes

-   [ALOY-628](https://jira-archive.titaniumsdk.com/ALOY-628). Error loading platform-specific theme-based styles
-   [ALOY-632](https://jira-archive.titaniumsdk.com/ALOY-632). Builtins being copied into Resources directory more than once causing runtime errors
-   [ALOY-633](https://jira-archive.titaniumsdk.com/ALOY-633). Compiler directives (OS_IOS) undefined when referenced inside a widget
-   [ALOY-635](https://jira-archive.titaniumsdk.com/ALOY-635). Styles not being sorted properly among global, controller, platform-specific, and theme
...
-   [ALOY-625](https://jira-archive.titaniumsdk.com/ALOY-625). app.tss not being applied to views that don't have view-specific styles.
-   [ALOY-626](https://jira-archive.titaniumsdk.com/ALOY-626). Remove unneeded resources from samples/mapping.
...
Refer to [Alloy Debugging](https://titaniumsdk.com/guide/Alloy_Debugging_and_Troubleshooting)
...
[Alloy Tasks](https://titaniumsdk.com/guide/Alloy_Tasks) for more information.
...
Refer to [Alloy Data Binding](https://titaniumsdk.com/guide/Alloy_Data_Binding)
for more information.
...
Refer to [Alloy Widgets](https://titaniumsdk.com/guide/Alloy_Widgets) for
more information.
...
Refer to [Alloy XML Markup](https://titaniumsdk.com/guide/Alloy_XML_Markup)
for more information.
...
[ALOY-485](https://jira-archive.titaniumsdk.com/ALOY-485).

Model-view binding with TableViews works fine and does not suffer from any known issues.

For more information, see the [Alloy Data Binding guide](https://titaniumsdk.com/guide/Alloy_Data_Binding).
...
guide](https://titaniumsdk.com/guide/Alloy_Sync_Adapters_and_Migrations) for
...
| API                   | Type              | Notes                                                                                                                                      |
| --------------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `Alloy.getCollection` | method            | Creates a local instance of a collection. Use [Alloy.createCollection](https://titaniumsdk.com/api/Alloy-method-createCollection) instead. |
| `Alloy.getController` | method            | Creates a local instance of a controller. Use [Alloy.createController](https://titaniumsdk.com/api/Alloy-method-createController) instead. |
| `Alloy.getModel`      | method            | Creates a local instance of a model. Use [Alloy.createModel](https://titaniumsdk.com/api/Alloy-method-createModel) instead.                |
| `Alloy.getWidget`     | method            | Creates a local instance of a widget. Use [Alloy.createWidget](https://titaniumsdk.com/api/Alloy-method-createWidget) instead.             |
| `Alloy.globals`       | property          | Global namespace. Use [Alloy.Globals](https://titaniumsdk.com/api/Alloy-property-Globals) instead.                                         |
| `datatime.js`         | builtin           | Collection of functions for datetime formatting. Use [moment.js](https://titaniumsdk.com/api/Alloy.builtins.moment) instead.               |
| `size`                | XML/TSS attribute | Defines size-specific view components or styles. Use the `formFactor` attribute instead.                                                   |

### New features

-   [ALOY-343](https://jira-archive.titaniumsdk.com/ALOY-343). Facilitate Alloy code completion in Studio.
-   [ALOY-437](https://jira-archive.titaniumsdk.com/ALOY-437). Support Android fastdev.
-   [ALOY-475](https://jira-archive.titaniumsdk.com/ALOY-475). Create test app for testing sql adapter apps with no migrations.

### Bug fixes and improvements

-   [ALOY-209](https://jira-archive.titaniumsdk.com/ALOY-209). Remove ti.physicalSizeCategory module for Alloy 1.0.0 (TiSDK 3.0+). Fixes [ALOY-188](https://jira-archive.titaniumsdk.com/ALOY-188) and [ALOY-134](https://jira-archive.titaniumsdk.com/ALOY-134).
-   [ALOY-313](https://jira-archive.titaniumsdk.com/ALOY-313). Use applyProperties to assign properties to Ti.Android.MenuItem in parser.
-   [ALOY-323](https://jira-archive.titaniumsdk.com/ALOY-323). Make Alloy support only TiSDK 3.0+.
-   [ALOY-407](https://jira-archive.titaniumsdk.com/ALOY-407). Make `alloy generate model` calls uniform in format, regardless of adapter. Fixes [ALOY-375](https://jira-archive.titaniumsdk.com/ALOY-375) where models were not being generated correctly in Titanium Studio.
-   [ALOY-429](https://jira-archive.titaniumsdk.com/ALOY-429). Convert jake app runner to use new CLI.
-   [ALOY-454](https://jira-archive.titaniumsdk.com/ALOY-454). iOS is rebuilding apps every time with new CLI.
-   [ALOY-455](https://jira-archive.titaniumsdk.com/ALOY-455). Remove Backbone eventing from Titanium proxies. Fixes [ALOY-460](https://jira-archive.titaniumsdk.com/ALOY-460) where ScrollableViews displayed noticeable lagging.
-   [ALOY-457](https://jira-archive.titaniumsdk.com/ALOY-457). Make Alloy sync adapter sync() function signature match that of Backbone.
-   [ALOY-473](https://jira-archive.titaniumsdk.com/ALOY-473). Abort compile process with message if trying to compile Alloy 1.0+ for anything less than Titanium 3.0.
-   [ALOY-476](https://jira-archive.titaniumsdk.com/ALOY-476). Widgets within model-bound view get bound to unexisting `$model`.
-   [ALOY-479](https://jira-archive.titaniumsdk.com/ALOY-479). Fix migration processing bug.
-   [ALOY-480](https://jira-archive.titaniumsdk.com/ALOY-480). Replace `sql` adapter with `sql_new`.
-   [ALOY-482](https://jira-archive.titaniumsdk.com/ALOY-482). View-based collection binding not properly clearing children before repopulating.
-   [ALOY-486](https://jira-archive.titaniumsdk.com/ALOY-486). `sql` adapter does not update ID in client-side model when using AUTOINCREMENT.

### Deprecations

-   [ALOY-330](https://jira-archive.titaniumsdk.com/ALOY-330). Make `alloy run` execute `titanium build`. The `alloy run` command will be removed in version 1.1.0 in favor of only using the `titanium build` command of the Titanium CLI.
...
-   [ALOY-474](https://jira-archive.titaniumsdk.com/ALOY-474). Allow extra commas in TSS files.
...
-   Tons of sql sync adapter features and fixes
    ...
    -   [ALOY-458](https://jira-archive.titaniumsdk.com/ALOY-458). The sql adapter now allows you to execute custom queries on fetch(). The [models/sql_queries](https://github.com/tidev/alloy/tree/master/test/apps/models/sql_queries) test app uses this, specifically in this [controller file](https://github.com/tidev/alloy/blob/master/test/apps/models/sql_queries/controllers/main.js).
    -   [ALOY-447](https://jira-archive.titaniumsdk.com/ALOY-447). Alloy Model column definitions now support SQLite keywords, like PRIMARY KEY and AUTOINCREMENT. The [models/sql_keywords](https://github.com/tidev/alloy/tree/master/test/apps/models/sql_keywords) test app shows how to use it.
    -   [ALOY-467](https://jira-archive.titaniumsdk.com/ALOY-467). idAttribute is now assignable from the model.js file's definition object. The [models/sql_keywords](https://github.com/tidev/alloy/tree/master/test/apps/models/sql_keywords) test app, specifically this [model file](https://github.com/tidev/alloy/blob/master/test/apps/models/sql_keywords/models/fighters.js) shows how to use it to identify which column in your table is the unique identifier for syncing between SQLite and Backbone.
    -   [ALOY-453](https://jira-archive.titaniumsdk.com/ALOY-453). Full support for up() and down() migrations in sql adapter. [models/sql_keywords](https://github.com/tidev/alloy/tree/master/test/apps/models/sql_keywords) is also a multiple migration test app.
    -   [ALOY-345](https://jira-archive.titaniumsdk.com/ALOY-345). sql adapter databases can now be preloaded from a database file. The [models/sql_preload](https://github.com/tidev/alloy/tree/master/test/apps/models/sql_preload) test app shows how.
    -   [ALOY-456](https://jira-archive.titaniumsdk.com/ALOY-456). sql adapter now supports multiple SQLite databases. The [model/sql_queries](https://github.com/tidev/alloy/tree/master/test/apps/models/sql_queries) test app makes use of multiple SQLite databases.
    -   [ALOY-468](https://jira-archive.titaniumsdk.com/ALOY-468). Added insertRow() and deleteRow() functions to migration object. You can see these in use for prepopulating and deleting rows in this [migration file](https://github.com/tidev/alloy/blob/master/test/apps/models/sql_queries/migrations/201301161234567_user.js) of the [models/sql_queries](https://github.com/tidev/alloy/tree/master/test/apps/models/sql_queries) test app.
-   TSS parsing and features
    -   [ALOY-272](https://jira-archive.titaniumsdk.com/ALOY-272). TSS parsing is now grammar based. Makes [code assist in TiStudio](https://jira-archive.titaniumsdk.com/ALOY-389) possible.
    -   [ALOY-252](https://jira-archive.titaniumsdk.com/ALOY-252). Commas are now optional between top-level style objects in TSS files. Check this [style file](https://github.com/tidev/alloy/blob/master/test/apps/models/sql_queries/styles/app.tss) for an example.
    -   [ALOY-452](https://jira-archive.titaniumsdk.com/ALOY-452). expr() syntax has been removed from TSS files. Here is the [cleaner and more powerful alternative](https://github.com/tidev/alloy/commit/e9fdc93c9760a1590c0abd0136662c11dc678066#commitcomment-2401085) for using runtime values in TSS files.
-   [ALOY-284](https://jira-archive.titaniumsdk.com/ALOY-284). Titanium constants can now be used as XML attributes in markup. Check this [view xml file](https://github.com/tidev/alloy/blob/master/test/apps/testing/grammar/views/index.xml) for an example.

### Bug fixes and improvements

-   [ALOY-191](https://jira-archive.titaniumsdk.com/ALOY-191). The [models/todo](https://github.com/tidev/alloy/tree/master/test/apps/models/todo) test app now works with all supported sync adapters \(sql, properties, localStorage\).
-   [ALOY-336](https://jira-archive.titaniumsdk.com/ALOY-336). Mobileweb logs not showing up in console \(related to [TISTUD-2525](https://jira-archive.titaniumsdk.com/TISTUD-2525)\).
-   [ALOY-449](https://jira-archive.titaniumsdk.com/ALOY-449). Parsing state not cleaned properly when processing multiple top-level UI elements.
-   [ALOY-446](https://jira-archive.titaniumsdk.com/ALOY-446). sql adapter should open/close between all operations (best practices).
...
-   [ALOY-432](https://jira-archive.titaniumsdk.com/ALOY-432). Added $.destroy() function to all controllers. When using model/collection binding in a controller, you **MUST** call this when closing a controller to prevent potential memory leaks. This is especially true if your binding makes references to global models/collections. More detailed documentation on this point will be added to the [Alloy Data Binding Guide](https://titaniumsdk.com/guide/Alloy_Models-section-34636390_AlloyModels-DataBinding) very soon. \([TEST APP](https://github.com/tidev/alloy/tree/master/test/apps/models/binding_destroy)\)

### New features

-   [ALOY-394](https://jira-archive.titaniumsdk.com/ALOY-394). Support collection binding on Views, allowing for arbitrary component repetition. \([TEST APP](https://github.com/tidev/alloy/tree/master/test/apps/models/journal)\)
-   [ALOY-103](https://jira-archive.titaniumsdk.com/ALOY-103). Support model binding of models to discrete properties on UI components. \([TEST APP](https://github.com/tidev/alloy/tree/master/test/apps/models/login)\)
-   [ALOY-382](https://jira-archive.titaniumsdk.com/ALOY-382), [ALOY-383](https://jira-archive.titaniumsdk.com/ALOY-383). Support in markup for proxy properties, like rightNavButton, leftNavButton, titleControl, etc... \([TEST APP](https://github.com/tidev/alloy/tree/master/test/apps/ui/proxy_properties)\)
-   [ALOY-387](https://jira-archive.titaniumsdk.com/ALOY-387), [ALOY-388](https://jira-archive.titaniumsdk.com/ALOY-388). Support view (XML) and controller (JS) code completion in Titanium Studio.
-   [ALOY-421](https://jira-archive.titaniumsdk.com/ALOY-421). Add moment.js as builtin. Deprecates datetime.s builtin.

### Bug fixes and improvements

-   [ALOY-342](https://jira-archive.titaniumsdk.com/ALOY-342). Support '--platform' option with 'alloy generate' command to create platform-specific views and controllers.
-   [ALOY-359](https://jira-archive.titaniumsdk.com/ALOY-359), [ALOY-423](https://jira-archive.titaniumsdk.com/ALOY-423). Improve buttongrid widget and fix a memory leak.
-   [ALOY-361](https://jira-archive.titaniumsdk.com/ALOY-361). Fix a bug with style prioritization as it relates to the formFactor attribute.
-   [ALOY-420](https://jira-archive.titaniumsdk.com/ALOY-420). Refactor TableView parser to allow model-bound tables to use proxy properties.
-   [ALOY-430](https://jira-archive.titaniumsdk.com/ALOY-430). Collection binding now responds to the Backbone "reset" event.
-   [ALOY-433](https://jira-archive.titaniumsdk.com/ALOY-433). Removed "unreachable code" warning in production Android builds.
-   [ALOY-436](https://jira-archive.titaniumsdk.com/ALOY-436). Alloy compile failures will now abort the Titanium build process, as expected, with the Titanium 3.0+ SDK.
-   [ALOY-438](https://jira-archive.titaniumsdk.com/ALOY-438). Fixed bug where the Backbone off() function on Titanium proxies created from markup was not working.
...
-   [ALOY-312](https://jira-archive.titaniumsdk.com/ALOY-312). Update Underscore.js to version 1.4.2 and Backbone.js to minified production 0.9.2 version.
-   [ALOY-367](https://jira-archive.titaniumsdk.com/ALOY-367), [ALOY-377](https://jira-archive.titaniumsdk.com/ALOY-377). Support Soasta touch test.
-   [ALOY-373](https://jira-archive.titaniumsdk.com/ALOY-373), [ALOY-379](https://jira-archive.titaniumsdk.com/ALOY-379). Add Collection tag in markup to create a singleton or instance(s) of a collection.
-   [ALOY-390](https://jira-archive.titaniumsdk.com/ALOY-390), [ALOY-391](https://jira-archive.titaniumsdk.com/ALOY-391). Add Model tag in markup to create a singleton or instance(s) of a model.
-   [ALOY-396](https://jira-archive.titaniumsdk.com/ALOY-396), [ALOY-397](https://jira-archive.titaniumsdk.com/ALOY-397), [ALOY-156](https://jira-archive.titaniumsdk.com/ALOY-156). Add completion callback to all methods in the animation.js builtin library.

### Bug fixes and improvements

-   [ALOY-311](https://jira-archive.titaniumsdk.com/ALOY-311). Improve Ti.UI.Android.MenuItem parser.
-   [ALOY-370](https://jira-archive.titaniumsdk.com/ALOY-370). Fix ability to assign functions with variable assigned functions in controllers.
-   [ALOY-376](https://jira-archive.titaniumsdk.com/ALOY-376). Improve handling of Ti.Android.Menu component.
-   [ALOY-393](https://jira-archive.titaniumsdk.com/ALOY-393). (Re-)enable optimizer.js as part of runtime JavaScript file optimization.
-   [ALOY-403](https://jira-archive.titaniumsdk.com/ALOY-403). Improve Alloy.Collection and Alloy.Model code optimization.
-   [ALOY-417](https://jira-archive.titaniumsdk.com/ALOY-417). Improve properties adapter.

### Deprecations

-   [ALOY-401](https://jira-archive.titaniumsdk.com/ALOY-401). Deprecate Alloy.globals; use Alloy.Globals instead.
...
-   [ALOY-353](https://jira-archive.titaniumsdk.com/ALOY-353). Support all Backbone eventing in Titanium proxies, on(), off(), trigger(). Fixed multiple event firing bug with on().
-   [ALOY-355](https://jira-archive.titaniumsdk.com/ALOY-355). Improve path handling in compiler plugin for OS X.
-   [ALOY-356](https://jira-archive.titaniumsdk.com/ALOY-356). Remove string builtin dependency to shorten compilation time.
-   [ALOY-365](https://jira-archive.titaniumsdk.com/ALOY-365). Add Alloy.globals namespace for global context.
-   [ALOY-380](https://jira-archive.titaniumsdk.com/ALOY-380). Create app/alloy.js file automatically for all new projects.
...
-   [ALOY-192](https://jira-archive.titaniumsdk.com/ALOY-192). Add to-do sample application. Code is available on [github](https://github.com/tidev/alloy/tree/master/test/apps/models/todo).
-   [ALOY-337](https://jira-archive.titaniumsdk.com/ALOY-337). Support themes to change the appearance of the entire GUI by customizing styles and assets. For more information, see:
    -   [Alloy Styles and Themes](https://titaniumsdk.com/guide/Alloy_Framework/Alloy_Guide/Alloy_Views/Alloy_Styles_and_Themes.html)
    -   [Themes sample application on github](https://github.com/tidev/alloy/tree/master/test/apps/advanced/themes)

### Bug fixes and improvements

-   [ALOY-306](https://jira-archive.titaniumsdk.com/ALOY-306). Support platform, formFactor, and inline event attributes with abstract types in markup.
-   [ALOY-340](https://jira-archive.titaniumsdk.com/ALOY-340). Fix Android "too deep recursion while parsing" error with Rhino runtime.
-   [ALOY-341](https://jira-archive.titaniumsdk.com/ALOY-341). Improve adapter-backbone processing.
-   [ALOY-352](https://jira-archive.titaniumsdk.com/ALOY-352). Fix SQL adapter to work if no migrations are present.
-   [ALOY-354](https://jira-archive.titaniumsdk.com/ALOY-354). Fix "alloy generate jmk" command.
